      ...
      {count > 0 ? (
        <div>
          ...
          <div className="content">
            <p>Thank You, {name}!</p>
            <p>
              Your order is complete, You should get an email confirmation from Paypal, soon. We'll
              get your order packed up and in the mail to you as soon as possible. I hope you enjoy
              your goodies and come back again.
            </p>
          </div>
        </div>
      ) : (
